    ...
    return <Container id="QuickLinks" className="pb-2">
        ...
        <Row className="pb-5">
            <Col className="d-flex justify-content-center">
                <a className="link-light h1 baskerville link-underline-opacity-0-hover" href="#AboutMe">Online CV</a>
            </Col>
            <Col className="d-flex justify-content-center">
                <a className="link-light h1 rocker link-underline-opacity-0-hover" href="#AboutMe">Projects</a>
            </Col>
            <Col className="d-flex justify-content-center">
                <a className="link-light h1 handjet link-underline-opacity-0-hover" href="#AboutMe">My Art</a>
            </Col>
        </Row>
    </Container>
}